...
const Home: NextPage = () => {
    ...
    return (
        <>
            {/* <Hero className="illustration-section-01" topOuterDivider={undefined} bottomOuterDivider={undefined} topDivider={undefined} bottomDivider={undefined} hasBgColor={undefined} invertColor={undefined} /> */}
            ...
            <HStack my={6} py={2} px={3} backgroundColor='black.90'>
                <Box px={3}>
